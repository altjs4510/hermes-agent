...
def route_classified_error(
    ...
    if _should_fallback and agent._fallback_index < len(agent._fallback_chain):
        ...
        # Fixes #11314. Billing exhaustion likewise won't recover by waiting (rotation already ran).
        _is_upstream = classified.reason == FailoverReason.upstream_rate_limit
        pool_may_recover = (
            False if (_is_upstream or classified.reason == FailoverReason.billing)
